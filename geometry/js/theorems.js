...
function renderSummary(theorem) {
  ...
  els.summary.innerHTML = `
    ...
    <div class="info-chip-row">
      ...
      ${theorem.course?.code ? `<span class="info-chip info-chip--accent">${escapeHtml(theorem.course.label || theorem.course.code)}</span>` : ""}
      ${theorem.course?.order ? `<span class="info-chip">نظرية ${escapeHtml(String(theorem.course.order).padStart(2, "0"))}</span>` : ""}
